const streamMusic='http://api.mp3.zing.vn/api/streaming/audio/';
...
const apiZingChart="http://mp3.zing.vn/xhr/chart-realtime?songId=0&videoId=0&albumId=0&chart=song&time=-1";
 function Start() {
...
function render(data) {
    ...
    data.forEach(element => {
         if(element.singer==undefined){
            element.singer='';
            element.img=`http://html2020.tamphat.edu.vn/tunein/html/images/td1.png`;
         }
        htmlRender+=`<li>
